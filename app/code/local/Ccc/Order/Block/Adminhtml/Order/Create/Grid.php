...
class Ccc_Order_Block_Adminhtml_Order_Create_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        return $this->getUrl('order/adminhtml_order_cart/index', array('id' => $row->getId()));
    }
